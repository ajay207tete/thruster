...
describe('Shopping Flow Test Suite', () => {
  const mockOrderData = {
    productDetails: 'Cyberpunk T-Shirt (Size: M, Color: Black, Qty: 2); Neon Sneakers (Size: L, Color: White, Qty: 1); VR Headset (Size: M, Color: Black, Qty: 1)',
  ...
  describe('Checkout Page Tests', () => {
    ...
    it('should display correct order summary', () => {
      ...
      expect(subtotal).toBeCloseTo(449.96, 2);
      expect(shipping).toBe(0);
      expect(total).toBeCloseTo(449.96, 2);
    });
  ...
  describe('Payment Processing Tests', () => {
    it('should validate payment amount', () => {
      ...
      expect(totalAmount).toBeCloseTo(449.96, 2);
    });

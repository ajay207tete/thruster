...
describe('PaymentService - Initialization Tests', () => {
  ...
  describe('Error Handling', () => {
    it('should handle payment errors correctly', () => {
      ...
      expect(paymentService.handlePaymentError(walletError, 'test')).toContain('Wallet not connected');
      expect(paymentService.handlePaymentError(contractError, 'test')).toContain('Smart contract failed');
      expect(paymentService.handlePaymentError(balanceError, 'test')).toContain('Insufficient balance');
    });

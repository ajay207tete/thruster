...
describe('PaymentService - Initialization Tests', () => {
  ...
  describe('Error Handling', () => {
    it('should handle payment errors correctly', () => {
      ...
      expect(paymentService.handlePaymentError(networkError, 'test')).toContain('Network connection error');
      ...
      expect(paymentService.handlePaymentError(balanceError, 'test')).toContain('Insufficient funds');
    });

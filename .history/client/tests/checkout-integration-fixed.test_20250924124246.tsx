/**
 * Checkout Integration Tests - Fixed Version
...
describe('Checkout Integration Tests', () => {
  ...
  describe('Complete Checkout Flow', () => {
    ...
    it('should display product details correctly', async () => {
      ...
      expect(getByText('Cyberpunk T-Shirt')).toBeTruthy();
      expect(getByText('Size: M')).toBeTruthy(); // Check for combined text
      expect(getByText('Color: Black')).toBeTruthy(); // Check for combined text
      expect(getByText('Quantity: 2')).toBeTruthy(); // Check for combined text

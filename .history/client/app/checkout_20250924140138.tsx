...
export default function CheckoutScreen() {
  ...
  const stableCartItemsParam = useMemo(() => cartItemsParam, [cartItemsParam]);
  ...
  const loadCartItems = useCallback(async () => {
    try {
      ...
      if (stableCartItemsParam && typeof stableCartItemsParam === 'string') {
        console.log('Loading from URL params');
        const parsedItems = JSON.parse(stableCartItemsParam);

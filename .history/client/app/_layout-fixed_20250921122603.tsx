...
export default function RootLayout() {
  ...
  return (
    <TonConnectUIProvider manifestUrl="https://chocolate-chemical-orangutan-457.mypinata.cloud/ipfs/bafkreib4t6hllayvqgy3lxo4ck7kunypktnqluhxpa7ozlxh46la6llbyq">

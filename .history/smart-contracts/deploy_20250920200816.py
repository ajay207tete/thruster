...
from tonclient.types import NetworkConfig, DeploySet, CallSet, Signer, ParamsOfEncodeMessage, ParamsOfSendMessage, ParamsOfWaitForTransaction, ParamsOfCompile
...
async def deploy_contract():
    ...
    compile_params = ParamsOfCompile(source=contract_source, stdlib=stdlib)
    compiled = await client.boc.compile(params=compile_params)

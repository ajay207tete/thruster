/**
 * Fixed Checkout Tests
 * Tests checkout functionality with corrected expectations
 */
...
describe('Checkout - Business Logic Tests', () => {
  describe('Price Calculations', () => {
    it('should calculate correct total for multiple items', () => {
      ...
      expect(total).toBe(149.97); // (29.99 * 2) + 89.99
    });
    ...
    it('should format price correctly', () => {
      ...
      expect(formatPrice(149.97)).toBe('$149.97');
    });
  });
  ...
  describe('Order Processing', () => {
    it('should create order object correctly', () => {
      ...
      expect(orderData.total).toBe(149.97);

...
/**
 * Test Runner Script (Fixed)
 * Runs comprehensive tests for shopping flow and smart contract functionality
...
async function runTests() {
  ...
  try {
    ...
    await runCommand('npm', ['test', '--', '--verbose', '--coverage', '--passWithNoTests']);
...
if (args.includes('--help') || args.includes('-h')) {
  ...
  log('================', 'bright');
  log('Usage: node run-tests-fixed.js [options]', '');
  log('Options:', 'yellow');
